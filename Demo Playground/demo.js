...
async function main() {
  const uri =
    'mongodb+srv://crowtherdb:Db12345%21@cluster0.dozth36.mongodb.net/test';
...
async function findListingsWithMinBedBathAndReviews(
  client,
  {
  ...
  if (results.length > 0) {
    console.log(
      `Found listing(s) with at least ${minimumNumberofBed} bedrooms and ${minimumNumberBath} bathrooms:`
    );
    ...
    console.log(
      `No listings founs with at least ${minimumNumberofBed} bedrooms and ${minimumNumberBath} bathrooms`
    );
  }
}
